    ...
    <div className="max-w-7xl mx-auto flex flex-col gap-6 pb-24">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-blue-50 text-[#0053CD] rounded-xl flex items-center justify-center shrink-0">
            <User size={24} />
          </div>
          <div>
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            <div className="bg-slate-50 border-b border-slate-100 p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-[#0053CD] text-white flex items-center justify-center font-bold text-sm">
                  1
                </div>
            ...
            <div className="p-6 flex flex-col gap-5">
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full border border-slate-200 rounded-lg px-4 py-2.5 text-sm text-slate-900 focus:outline-none focus:border-[#0053CD] focus:ring-1 focus:ring-[#0053CD]"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative mb-3">
                  ...
                  <input 
                    ...
                    className="w-full border border-slate-200 rounded-lg pl-9 pr-4 py-2.5 text-sm text-slate-900 focus:outline-none focus:border-[#0053CD] focus:ring-1 focus:ring-[#0053CD]"
                  />
                </div>
                <div className="flex flex-wrap gap-2">
                  <span className="flex items-center gap-1.5 bg-[#F0F7FF] text-[#0053CD] border border-[#E6F0FF] px-3 py-1.5 rounded-lg text-xs font-medium">
                    Douleur thoracique
                    <button className="text-[#0053CD] hover:text-[#003B93]"><X size={12} /></button>
                  </span>
                  <span className="flex items-center gap-1.5 bg-[#F0F7FF] text-[#0053CD] border border-[#E6F0FF] px-3 py-1.5 rounded-lg text-xs font-medium">
                    Essoufflement
                    <button className="text-[#0053CD] hover:text-[#003B93]"><X size={12} /></button>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full border border-slate-200 rounded-lg px-4 py-3 text-sm text-slate-900 focus:outline-none focus:border-[#0053CD] focus:ring-1 focus:ring-[#0053CD] resize-none leading-relaxed"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 mt-2">
                <div>
                  ...
                  <div className="flex p-1 bg-slate-50 rounded-lg border border-slate-100">
                    ...
                    <button className="flex-1 text-xs font-bold text-[#0053CD] bg-white py-2 rounded-md shadow-sm border border-slate-200 transition-all">Modéré</button>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div className="p-5 flex items-start justify-between">
              ...
              <button className="text-slate-400 hover:text-[#0053CD] transition-colors p-2 hover:bg-slate-50 rounded-lg">
                <Edit3 size={18} />
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            <div className="bg-slate-50 border-b border-slate-100 p-4 flex items-center justify-between">
              ...
              <span className="bg-[#E6F0FF] text-[#0053CD] text-[10px] font-bold px-2 py-1 rounded-md border border-[#CCE0FF]">
                En attente
              </span>
            </div>
            <div className="p-5">
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3 p-3 border border-slate-200 rounded-xl bg-slate-50/50">
                  <div className="w-8 h-8 rounded-lg bg-[#E6F0FF] text-[#0053CD] flex items-center justify-center shrink-0">
                    <Activity size={16} />
                  </div>
        ...
        <div className="lg:col-span-1 flex flex-col gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
            <div className="flex items-center justify-between mb-5">
              <h3 className="text-[15px] font-bold text-slate-900 flex items-center gap-2">
                <FileText size={18} className="text-[#0053CD]" />
                Ordonnance Médicale
              </h3>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="bg-[#0053CD] text-white text-[10px] font-bold px-2 py-0.5 rounded-full">
                2 fichiers
              </span>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
            ...
            <div className="relative border-l border-slate-200 ml-3 space-y-6 pb-2">
              ...
              {/* En attente */}
              <div className="relative pl-6">
                <div className="absolute -left-[9px] top-0.5 w-4 h-4 rounded-full bg-[#E6F0FF] border-2 border-white text-[#0053CD] flex items-center justify-center box-content">
                  <Clock size={12} />
                </div>
                <div>
                  <p className="text-[10px] font-bold text-[#0053CD] uppercase tracking-wider mb-0.5">En attente</p>
      ...
      <div className="fixed bottom-0 left-64 right-0 bg-white border-t border-slate-200 p-4 px-8 flex items-center justify-between z-40 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        ...
        <div className="flex items-center gap-3">
          <button 
            ...
            className="px-5 py-2.5 rounded-xl border border-slate-200 text-[#0053CD] text-sm font-bold hover:bg-slate-50 transition-colors flex items-center gap-2"
          >
            <Plus size={16} />
            Ajouter une étape
          </button>
          <button className="px-5 py-2.5 rounded-xl bg-[#E6F0FF] text-[#0053CD] text-sm font-bold hover:bg-[#CCE0FF] transition-colors">
            Sauvegarder
          </button>
          <button className="px-5 py-2.5 rounded-xl bg-[#0053CD] text-white text-sm font-bold hover:bg-[#0041A3] transition-colors">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="bg-white rounded-xl w-full max-w-2xl shadow-2xl relative overflow-hidden flex flex-col p-6">
            ...
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-sm font-bold text-[#0053CD] uppercase tracking-wider">AJOUTER UNE ÉTAPE</h2>
              <button 
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              {[
                ...
                <button 
                  ...
                  className="flex flex-col items-center justify-center gap-3 p-6 border border-slate-200 rounded-xl hover:border-[#0053CD] hover:bg-[#F0F7FF] transition-all group"
                >
                  <div className="text-slate-400 group-hover:text-[#0053CD]">
                    <item.icon size={24} strokeWidth={1.5} />
                  </div>
                  <span className="text-[11px] font-bold text-slate-700 group-hover:text-[#0053CD]">{item.label}</span>
                </button>
              ))}
            </div>
          ...
          <div className="bg-[#F8FAFC] rounded-xl w-full max-w-5xl h-[90vh] shadow-2xl relative flex flex-col overflow-hidden border border-slate-200">
            ...
            <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-5">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="bg-white rounded-xl border border-slate-200 p-3 flex-1 flex items-center gap-3 shadow-sm">
                  <div className="w-10 h-10 bg-blue-50 text-[#0053CD] rounded-lg flex items-center justify-center shrink-0">
                    <User size={20} />
                  </div>
                  <div>
                ...
                <div className="bg-white rounded-xl border border-slate-200 p-3 flex-1 flex flex-col items-center justify-center shadow-sm">
                  ...
                  <span className="text-sm font-bold text-[#0053CD]">O+</span>
                </div>
                <div className="bg-white rounded-xl border border-slate-200 p-3 flex-1 flex flex-col items-center justify-center shadow-sm">
                ...
                <div className="bg-white rounded-xl border border-slate-200 p-3 flex-1 flex flex-col items-center justify-center shadow-sm">
                  ...
                  <span className="text-sm font-bold text-[#0053CD]">78 bpm</span>
                </div>
                ...
                <div className="lg:col-span-2 flex flex-col gap-6">
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                    <div className="flex items-center gap-2 mb-4">
                      <Search size={16} className="text-[#0053CD]" strokeWidth={2.5} />
                    ...
                    <div className="relative mb-4">
                      ...
                      <input 
                        ...
                        className="w-full border border-slate-200 rounded-lg pl-9 pr-4 py-2.5 text-sm text-slate-900 bg-slate-50 focus:outline-none focus:border-[#0053CD] focus:ring-1 focus:ring-[#0053CD]"
                      />
                    </div>
                        ...
                        <tbody className="divide-y divide-slate-100">
                          <tr>
                            ...
                            <td className="py-3 text-right">
                              <button className="text-sm font-bold text-[#0053CD] hover:underline">Ajouter</button>
                            </td>
                          </tr>
                          <tr>
                  ...
                  {/* Diagnostic Actuel */}
                  <div className="bg-white rounded-xl border border-[#0053CD]/20 p-5 shadow-sm relative overflow-hidden">
                    {/* Tiny blue bar on top for emphasis */}
                    <div className="absolute top-0 left-0 right-0 h-1 bg-[#0053CD]"></div>
                    
                    <div className="flex items-center gap-2 mb-5 mt-1">
                      <CheckSquare size={16} className="text-[#0053CD]" strokeWidth={2.5} />
                    ...
                    <div className="flex flex-col gap-5">
                      ...
                      <div>
                        ...
                        <div className="flex items-center justify-between border border-[#0053CD]/30 bg-[#F0F7FF] rounded-lg p-2 pr-3">
                          <div className="flex items-center gap-3">
                            <div className="bg-[#0053CD] text-white text-xs font-bold px-2 py-1.5 rounded-md">
                              I10
                            </div>
                      ...
                      <div>
                        ...
                        <textarea 
                          ...
                          rows={3}
                          className="w-full bg-slate-50 border border-slate-200 rounded-lg p-3 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#0053CD] resize-none"
                        ></textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                    ...
                    <div className="mb-5">
                      ...
                      <div className="flex p-1 bg-slate-50 rounded-lg border border-slate-100">
                        ...
                        <button className="flex-1 text-[11px] font-bold text-[#0053CD] bg-[#E6F0FF] border border-[#CCE0FF] py-1.5 rounded transition-all">Modérée</button>
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                    ...
                    <div className="flex flex-col gap-3 mb-5">
                      <label className="flex items-center gap-3 cursor-pointer group">
                        <div className="text-[#0053CD]">
                          <CheckSquare size={18} className="fill-[#0053CD] text-white" />
                        </div>
                        <span className="text-sm font-medium text-slate-900 group-hover:text-[#0053CD] transition-colors">Douleur thoracique légère</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer group">
                        <div className="text-[#0053CD]">
                          <CheckSquare size={18} className="fill-[#0053CD] text-white" />
                        </div>
                        <span className="text-sm font-medium text-slate-900 group-hover:text-[#0053CD] transition-colors">Fatigue persistante</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer group">
            ...
            <div className="bg-slate-100 border-t border-slate-200 p-4 flex items-center justify-between shrink-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <button 
                  onClick={() => setIsDiagnosticModalOpen(false)}
                  className="flex items-center gap-2 px-5 py-2.5 bg-[#0053CD] hover:bg-[#0041A3] text-white rounded-lg text-sm font-bold transition-colors shadow-sm"
                >
                  <CheckSquare size={16} />
                ...
                <div className="lg:col-span-2 flex flex-col gap-6">
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                    <div className="flex items-center gap-2 mb-6">
                      <FlaskConical size={18} className="text-[#0053CD]" strokeWidth={2.5} />
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-5">
                      <div>
                        ...
                        <div className="relative">
                          <select className="w-full appearance-none bg-white border border-slate-200 rounded-lg pl-4 pr-10 py-2.5 text-sm font-semibold text-slate-700 focus:outline-none focus:border-[#0053CD] focus:ring-1 focus:ring-[#0053CD] cursor-pointer">
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full border border-slate-200 rounded-lg px-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#0053CD] focus:ring-1 focus:ring-[#0053CD]"
                      />
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                    <div className="flex items-center gap-2 mb-6">
                      <FileText size={18} className="text-[#0053CD]" strokeWidth={2.5} />
                    ...
                    <div className="flex flex-col gap-5">
                      <div>
                        ...
                        <textarea 
                          ...
                          rows={3}
                          className="w-full bg-slate-50/50 border border-slate-200 rounded-lg p-4 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#0053CD] focus:ring-1 focus:ring-[#0053CD] resize-none"
                        ></textarea>
                      </div>
                ...
                <div className="lg:col-span-1 flex flex-col gap-6">
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="relative">
                        <div className="absolute left-3 top-1/2 -translate-y-1/2 text-[#0053CD]">
                          <Microscope size={18} />
                        </div>
                        <select className="w-full appearance-none bg-slate-50/50 border border-slate-200 rounded-lg pl-10 pr-10 py-2.5 text-sm font-semibold text-slate-700 focus:outline-none focus:border-[#0053CD] cursor-pointer">
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                    ...
                    <div className="flex flex-col gap-3">
                      <button className="flex flex-col items-center justify-center gap-2 border-2 border-dashed border-slate-200 hover:border-[#0053CD] rounded-xl p-5 transition-colors group cursor-pointer bg-slate-50/50 hover:bg-[#F0F7FF]">
                        <FileUp size={24} className="text-slate-400 group-hover:text-[#0053CD]" />
                        <div className="text-center">
                          <p className="text-xs font-bold text-slate-700 group-hover:text-[#0053CD]">Joindre Ordonnance</p>
          ...
          <div className="bg-[#F8FAFC] rounded-xl w-full max-w-5xl h-[90vh] shadow-2xl relative flex flex-col overflow-hidden border border-slate-200">
            ...
            <div className="flex-1 overflow-y-auto p-6 lg:p-8 flex flex-col gap-6">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-blue-50 text-[#0053CD] font-bold text-lg rounded-xl flex items-center justify-center shrink-0">
                    AC
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-6 text-right">
                  <div>
                    ...
                    <p className="text-sm font-bold text-[#0053CD]">I10 - Hypertension</p>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 flex flex-col gap-6">
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                    ...
                    <div className="relative mb-5">
                      ...
                      <input 
                        ...
                        className="w-full border border-slate-200 rounded-lg pl-9 pr-4 py-2.5 text-sm text-slate-900 bg-white focus:outline-none focus:border-[#0053CD] focus:ring-1 focus:ring-[#0053CD]"
                      />
                    </div>
                      ...
                      <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-slate-100">
                          <tr className="bg-[#F0F7FF]">
                            <td className="py-3 px-4 text-xs font-bold text-[#0053CD]">Amlodipine</td>
                            ...
                            <td className="py-3 px-4 text-right">
                              <span className="inline-block bg-[#0053CD] text-white text-[10px] font-bold px-3 py-1 rounded uppercase tracking-wider">
                                Sélectionné
                              </span>
                            </td>
                          </tr>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                      <div className="flex items-center gap-2 mb-4">
                        <Pill size={16} className="text-[#0053CD]" strokeWidth={2.5} />
                      ...
                      <div className="mb-4">
                        ...
                        <div className="relative">
                          <select className="w-full appearance-none bg-white border border-slate-200 rounded-lg pl-3 pr-8 py-2 text-sm font-bold text-slate-700 focus:outline-none focus:border-[#0053CD] cursor-pointer">
                            <option>5mg</option>
                            <option>10mg</option>
                          </select>
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-4">
                        <div>
                          ...
                          <div className="relative">
                            <select className="w-full appearance-none bg-white border border-slate-200 rounded-lg pl-3 pr-8 py-2 text-sm font-semibold text-slate-700 focus:outline-none focus:border-[#0053CD] cursor-pointer">
                              <option>Orale</option>
                            </select>
                            <ChevronDown size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" />
                          </div>
                      ...
                      <div className="flex flex-col gap-3">
                        <label className="flex items-center gap-2 cursor-pointer group">
                          <div className="text-[#0053CD]">
                            <CheckSquare size={16} className="fill-[#0053CD] text-white" />
                          </div>
                          <span className="text-xs font-semibold text-slate-900 group-hover:text-[#0053CD] transition-colors">Matin</span>
                        </label>
                        <label className="flex items-center gap-2 cursor-pointer group">
                          <div className="text-[#0053CD]">
                            <CheckSquare size={16} className="fill-[#0053CD] text-white" />
                          </div>
                          <span className="text-xs font-semibold text-slate-900 group-hover:text-[#0053CD] transition-colors">Avec nourriture</span>
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                      <div className="flex items-center gap-2 mb-4">
                        <Calendar size={16} className="text-[#0053CD]" strokeWidth={2.5} />
                        <h3 className="text-sm font-bold text-slate-900">Durée</h3>
                      </div>

                      <div className="flex gap-2 mb-5">
                        <button className="flex-1 bg-[#0053CD] text-white py-1.5 rounded-full text-[11px] font-bold border border-[#0053CD] transition-all">30 Jours</button>
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                    ...
                    <div className="mb-5">
                      ...
                      <textarea 
                        ...
                        rows={2}
                        className="w-full bg-white border border-slate-200 rounded-lg p-3 text-sm text-slate-900 focus:outline-none focus:border-[#0053CD] resize-none"
                      ></textarea>
                    </div>

                    <div className="grid grid-cols-2 gap-3">
                      <div className="flex items-center gap-2 p-2.5 border border-slate-200 rounded-lg hover:border-[#0053CD]/50 transition-colors group cursor-pointer">
                        <CheckSquare size={16} className="text-[#0053CD] fill-[#0053CD] text-white" />
                        <span className="text-xs font-semibold text-slate-700 group-hover:text-[#0053CD]">Ne pas dépasser la dose</span>
                      </div>
                      <div className="flex items-center gap-2 p-2.5 border border-slate-200 rounded-lg hover:border-[#0053CD]/50 transition-colors group cursor-pointer">
                        <CheckSquare size={16} className="text-[#0053CD] fill-[#0053CD] text-white" />
                        <span className="text-xs font-semibold text-slate-700 group-hover:text-[#0053CD]">Éviter alcool</span>
                      </div>
                      <div className="flex items-center gap-2 p-2.5 border border-slate-200 rounded-lg hover:border-[#0053CD]/50 transition-colors group cursor-pointer">
                        <CheckSquare size={16} className="text-[#0053CD] fill-[#0053CD] text-white" />
                        <span className="text-xs font-semibold text-slate-700 group-hover:text-[#0053CD]">Surveiller tension artérielle</span>
                      </div>
                      <div className="flex items-center gap-2 p-2.5 border border-slate-200 rounded-lg hover:border-[#0053CD]/50 transition-colors group cursor-pointer">
                        <CheckSquare size={16} className="text-[#0053CD] fill-[#0053CD] text-white" />
                        <span className="text-xs font-semibold text-slate-700 group-hover:text-[#0053CD]">Signaler effets indésirables</span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="lg:col-span-1 flex flex-col gap-6">
                  ...
                  <div className="bg-[#F8FAFC] rounded-xl border border-slate-200 p-5 shadow-sm">
                    <div className="flex items-center gap-2 mb-4">
                      <ShieldCheck size={16} className="text-[#0053CD]" strokeWidth={2.5} />
                      <h3 className="text-[11px] font-bold text-[#0053CD] uppercase tracking-wider">CONTRÔLES DE SÉCURITÉ</h3>
                    </div>
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex items-center justify-between bg-white px-3 py-2 rounded-lg border border-slate-200">
                        ...
                        <span className="bg-[#F0F7FF] text-[#0053CD] text-[10px] font-bold px-2 py-0.5 rounded-md border border-[#CCE0FF]">
                          FAIBLE
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="relative">
                        <select className="w-full appearance-none bg-white border border-slate-200 rounded-lg pl-3 pr-8 py-2.5 text-sm font-semibold text-slate-700 focus:outline-none focus:border-[#0053CD] cursor-pointer">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex items-center gap-4">
                        <label className="flex items-center gap-2 cursor-pointer group">
                          <CheckSquare size={16} className="text-[#0053CD] fill-[#0053CD] text-white" />
                          <span className="text-xs font-semibold text-slate-900 group-hover:text-[#0053CD]">Médecin</span>
                        </label>
                        <label className="flex items-center gap-2 cursor-pointer group">
                          <CheckSquare size={16} className="text-[#0053CD] fill-[#0053CD] text-white" />
                          <span className="text-xs font-semibold text-slate-900 group-hover:text-[#0053CD]">Infirmier</span>
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-3">
                      <div className="flex items-center justify-between bg-[#F0F7FF] border border-[#CCE0FF] p-3 rounded-lg">
                        <div className="flex items-start gap-3">
                          <CheckSquare size={16} className="text-[#0053CD] fill-[#0053CD] text-white mt-0.5 shrink-0" />
                          <div>
                            <p className="text-xs font-bold text-slate-900">Consultation C-001</p>
                            <p className="text-[10px] text-slate-500">15/05/2026</p>
                          </div>
                        </div>
                        <Link2 size={16} className="text-[#0053CD]" />
                      </div>
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm flex flex-col items-center justify-center p-8 relative">
                    ...
                    <FileText size={40} className="text-[#0053CD] mb-3" strokeWidth={1.5} />
            ...
            <div className="bg-slate-100 border-t border-slate-200 p-4 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                ...
                <button className="px-5 py-2.5 bg-slate-200/50 border border-slate-300 rounded-lg text-sm font-bold text-[#0053CD] hover:bg-slate-200 transition-colors">
          ...
          <div className="bg-[#F8FAFC] rounded-xl w-full max-w-4xl shadow-2xl relative flex flex-col overflow-hidden border border-slate-200">
            ...
            <div className="flex-1 p-8 flex flex-col gap-6">
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h2 className="text-[28px] font-black text-[#0053CD] mb-1">Génération d'Ordonnance</h2>
                ...
                <div className="flex items-center gap-3 px-4 py-2 border border-slate-200 bg-white rounded-xl shadow-sm">
                  <div className="text-right">
                    ...
                    <p className="text-sm font-bold text-[#0053CD]">Dr. Hounkpatin</p>
                    <p className="text-[10px] text-[#0053CD]/70">Cardiologue</p>
                  </div>
                </div>
              </div>
                ...
                <div className="md:col-span-5 flex flex-col gap-6">
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-12 h-12 bg-[#E6F0FF] text-[#0053CD] font-bold text-lg rounded-xl flex items-center justify-center shrink-0">
                        AC
                      </div>
                      <div>
                        <h3 className="text-base font-bold text-slate-900">A. Codjo</h3>
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                    <div className="flex items-center gap-2 mb-5">
                      <ShieldCheck size={18} className="text-[#0053CD]" strokeWidth={2.5} />
                ...
                <div className="md:col-span-7 flex flex-col gap-6">
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-sm font-bold text-[#0053CD]">Détails du Traitement</h3>
                      <button className="text-xs font-bold text-[#0053CD] hover:underline flex items-center gap-1">
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="border border-slate-200 rounded-xl p-4 flex gap-4">
                        <div className="w-10 h-10 rounded-lg bg-[#0053CD] text-white flex items-center justify-center shrink-0">
                          <Pill size={20} />
                        </div>
                        <div className="flex-1">
                          ...
                          <div className="flex gap-2">
                            <span className="flex items-center gap-1.5 bg-[#F0F7FF] text-[#0053CD] px-2.5 py-1 rounded-md text-[11px] font-bold">
                        ...
                        <div className="flex flex-col items-center justify-between">
                          ...
                          <button className="text-slate-400 hover:text-[#0053CD] transition-colors">
                            <Pen size={16} />
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <label className="flex items-center gap-3 p-3 border border-slate-200 rounded-lg cursor-pointer group hover:border-[#0053CD]/50">
                        <CheckSquare size={18} className="text-[#0053CD] fill-[#0053CD] text-white shrink-0" />
                        <span className="text-xs font-bold text-slate-700 group-hover:text-[#0053CD]">Générer PDF</span>
                      </label>
                      <label className="flex items-center gap-3 p-3 border border-slate-200 rounded-lg cursor-pointer group hover:border-[#0053CD]/50">
                        <CheckSquare size={18} className="text-[#0053CD] fill-[#0053CD] text-white shrink-0" />
                        <span className="text-xs font-bold text-slate-700 group-hover:text-[#0053CD]">Envoyer au<br/>patient</span>
                      </label>
                      <label className="flex items-center gap-3 p-3 border border-slate-200 rounded-lg cursor-pointer group hover:border-[#0053CD]/50">
                        <CheckSquare size={18} className="text-[#0053CD] fill-[#0053CD] text-white shrink-0" />
                        <span className="text-xs font-bold text-slate-700 group-hover:text-[#0053CD]">Archiver au<br/>dossier</span>
                      </label>
                    </div>
                  </div>
              ...
              <div className="flex items-center justify-between mt-6 pt-6 border-t border-slate-200">
                ...
                <div className="flex items-center gap-3">
                  <button className="flex items-center justify-center gap-2 px-6 py-3 bg-slate-100 hover:bg-slate-200 text-[#0053CD] rounded-lg text-sm font-bold transition-colors shadow-sm">
                    <Download size={16} />
                    Télécharger PDF
                  </button>
                  <button className="flex items-center justify-center gap-2 px-6 py-3 bg-[#E6F0FF] hover:bg-[#CCE0FF] text-[#0053CD] rounded-lg text-sm font-bold transition-colors shadow-sm">
                    <Send size={16} />
                    Envoyer
                  </button>
                  <button 
                    onClick={() => setIsOrdonnanceModalOpen(false)}
                    className="flex items-center justify-center gap-2 px-6 py-3 bg-[#0053CD] hover:bg-[#0041A3] text-white rounded-lg text-sm font-bold transition-colors shadow-sm"
                  >
